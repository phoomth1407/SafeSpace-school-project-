...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (rawMessage.toLowerCase().includes("sending confirmation email")) {
        setError("Supabase could not send the confirmation email. The app is working, but the Supabase email service needs to be configured or may have reached its email limit.");
      } else {
        setError(rawMessage);
      }
    } finally {
